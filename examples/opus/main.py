#!/usr/bin/env python3
"""Entry point for the OPUS online-data-selection pretraining example.

Reuses the shared/ model + data utilities under examples/lm/ and the GradProjLora
ghost engine for per-sample gradient sketching (see opus_scorer.py).
"""
...
from training_loop import OpusTrainer

...
> **Provenance warning (2026-07-04):** these logs were run before a 2026-07-02 LR-schedule
...
> arms shared the schedule), but do **not** compare new runs against these curves.
> Same-code reruns of Regular and GREATS-excl live in
> [`examples/opus/experiments/logs/`](../../../opus/experiments/README.md).
